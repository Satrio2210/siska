...
<div id="layout">
    	...
    	<div id="menu">
			...
			<ul class="pure-menu-list">
              ...
              <li class="pure-menu-item" onclick="javascript: location.href = 'TBLACOAC00.php'">
                <a class="pure-menu-link">Group Akun</a>
              </li>
	...
	<div id="main">
        ...
        <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'REPOACCT03.php'">
                <a class="pure-menu-link">
                Profit Loss
                </a>
              </li>
      ...
      <!-- Tab Menu -->
      <!-- Form Menu -->
      <form name="frmrepoacct" class="pure-form" method="post" action="REPOACCT01P.php">
      ...
      <fieldset>
          ...
          onchange="ambilviewgele(this.value,document.getElementById('tglenddate').value);">
          ...
          id="tglenddate"
          value="<?php echo $datenow;?>" 
          onchange="ambilviewgele(document.getElementById('tglstartdate').value,this.value);">

          <a class="pure-button button-print" 
          onclick="javascript: document.frmrepoacct.submit();">Print</a>
...
<script src="js/REPOACCT01.js"></script>
