...
<div id="layout">
        ...
        <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'TRXALABO07.php'">
    ...
    <!-- Tab Menu -->
      ...
      <form name="frmreport" class="pure-form" method="post" action="TRXALABO06P.php">
...
<script src="js/TRXALABO06.js"></script>
