...
<body onLoad="periksaakses('PASS_STOCK_REPO');
">
<div id="layout">
	<!-- Menu toggle -->
    ...
    <form name="frminvestock" class="pure-form" method="post">
      ...
      <fieldset>
      <label for="txtstockcode">Cari ...</label>
      <input type="text" class="pure-input-rounded"
             name="txtstockcode" 
             id="txtstockcode" 
             maxlength ="20"
             style="width: 200px;"
            onkeyup="if (value.length > 0) { ambilviewstock(this.value); };"
...
<script src="js/INVESTOCK04.js"></script>
