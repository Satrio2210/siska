    ...
    <form name="frmtrxapoli" class="pure-form pure-form-aligned" method="post" action="">
    	<fieldset>
          ...
          <div class="pure-control-group">
            ...
            <textarea id="txtexamkeluh" name="txtexamkeluh"
            rows="4" cols="30" disabled>BELUM DAPAT DI ISI!!!!
          ...
          <div class="pure-control-group">
            ...
            <textarea id="txtexamdiag" name="txtexamdiag"
            rows="4" cols="30">
      ...
      <fieldset>
        ...
        ">Submit</a>
        <label style="margin-left:50px"for="ctk-surat">Pilih Surat</label>
            <select id="ctk-surat">
              <option value="">-Silahkan Pilih Surat-</option>
              <option value="skbs">SKBS</option>
              <option value="skbw">SKBW</option>
              <option value="skbws">SKBWS</option>
            </select>
        <a class="pure-button pure-button-primary">Cetak Surat</a>
      </fieldset>
