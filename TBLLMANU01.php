...
<title>Nilai Normal Kualitatif</title>
...
<div id="layout">
    ...
    <!-- Form Input -->
    <form name="frmtbllmanu" class="pure-form pure-form-aligned" method="post" action="">
    	<fieldset>

      		<div class="pure-control-group">

        		<label for="txtmanucode">Kode :</label>
              <input type="text" 
            	  	name="txtmanucode" 
              		id="txtmanucode" 
              		maxlength ="2"
                  ...
                  onkeydown="if (event.keyCode == 13 && value.length > 0)
                            ...
                            {
                                document.getElementById('txtmanuname').setAttribute('disabled','true');              
                            } 
                  ">
          ...
          <div class="pure-control-group">
            ...
            <label for="txtmanuname">Hasil Pengamatan :</label>
              <input type="text" 
                  name="txtmanuname" 
                  id="txtmanuname" 
                  maxlength ="50"
                  ...
                  onkeydown="if (event.keyCode == 13 && value.length > 0)
                  {
                    if (document.getElementById('txtmanucode').value == '')
                      {
                        swal({
                            title: 'Kode Manual Kosong' ,
                            text: 'Anda belum mengisi Kode Manual, silah periksa lagi',
                            icon: 'warning',
                            });
                        document.getElementById('txtmanucode').value = '';
                        document.getElementById('txtmanucode').focus();
                  }
                  else if (document.getElementById('txtmanuname').value == '')
                  {
                      swal({
                          title: 'Hasil Manual Kosong' ,
                          text: 'Anda belum mengisi Hasil Manual, silah periksa lagi',
                          icon: 'warning',
                          });
                      document.getElementById('txtmanuname').value = '';
                      document.getElementById('txtmanuname').focus();
                  }

                   else
                   {
                       var inmanucode = document.getElementById('txtmanucode').value;
                       var inmanuname = document.getElementById('txtmanuname').value;
                       input(inmanucode,inmanuname);
                    }
      ...
      <fieldset>
          <a class="pure-button pure-button-primary" onclick="javascript:
                  ...
                  {
                      swal({
                          title: 'Nama Manual Kosong' ,
                          text: 'Anda belum mengisi Nama Manual, silah periksa lagi',
                          icon: 'warning',
                          });
                      document.getElementById('txtmanuname').value = '';
                      document.getElementById('txtmanuname').focus();
...
<script src="js/TBLLMANU01.js"></script>
