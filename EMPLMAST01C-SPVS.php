...
#screen tbody 
{
  ...
  <thead>
  <tr>
  <th style="width: 200px;">EMPL CODE</th>
  <th style="width: 500px;">EMPL NAME</th>
  </tr>
  </thead>
  <tbody>
<?php
...
echo '<tr>';
echo '<td style="width: 200px;" onClick="isispvscode(\''.$outemplcode.'\',\''.$outmastname.'\');" 
      style="cursor:pointer">'.$k['EMPL_MAST_CODE'].'</td>';
echo '<td style="width: 500px;" onClick="isispvscode(\''.$outemplcode.'\',\''.$outmastname.'\');" 
