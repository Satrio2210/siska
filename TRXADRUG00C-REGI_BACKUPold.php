...
<?php
  ...
  $xquery = "SELECT TRXA_REGI_CODE, TRXA_PATI_CODE, 
                ...
                FROM trxaregi
                WHERE TRXA_REGI_POLI <> '$code_lab_room' AND TRXA_REGI_STAT IN ('C','W')
  ...
  $xquery = "SELECT TRXA_REGI_CODE, TRXA_PATI_CODE, 
                ...
                AND TRXA_REGI_POLI <> '$code_lab_room' AND TRXA_REGI_STAT IN ('C','W')
                ORDER BY TRXA_ENTR_DATE DESC, TRXA_ENTR_TIME DESC";        
  }
...
while ($k = $q->fetch(PDO::FETCH_ASSOC))
{
  ...
  if($outregipoli == 'PU') { $outregipoli = 'Poli Umum';}
  elseif ($outregipoli == 'LB') { $outregipoli = 'Lab';}
  elseif ($outregipoli == 'PG') { $outregipoli = 'Poli Gigi';}
  elseif ($outregipoli == 'KB') { $outregipoli = 'Poli KIA';}
  else { $outregipoli = '';}
...
echo '<td style="width: 150px;" onClick="isiregi(\''.$outprsccode.'\',\''.$outpaticode.'\',\''.$outmainname.'\',\''.$outmaingend.'\',\''.$outmainage.'\',\''.$outregipaym.'\',\''.$outpaymcode.'\',\''.$outregipoli.'\',\''.$outexamprsc.'\');" 
