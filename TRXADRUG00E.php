...
$rawdata = $_POST['q'];
list($prsccode,$prscdoct,$stockcode,$stockbtch,$stockpric,$stockquty,$prscconc, $prscsgna,$mediroom) = explode("|", $rawdata);
...
$input = "INSERT INTO trxaprsc (
        ...
        ':TRXA_STOCK_BTCH' =>$stockbtch,':TRXA_PRSC_CONC' =>$prscconc,                
...
{
$update = "UPDATE trxaprsc SET TRXA_STOCK_BTCH='$stockbtch',TRXA_PRSC_CONC='$prscconc', 
