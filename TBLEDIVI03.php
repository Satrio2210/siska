...
<div id="layout">
    ...
    <!-- Form Input -->
    <form name="frmtbledivi" class="pure-form pure-form-aligned" method="post" action="TBLEDIVI03D.php">
      <fieldset>
        ...
        <label for="txtdivicode">Kode Divisi :</label>
            ...
            onkeyup="var start = this.selectionStart;
                ...
                onkeydown="if (event.keyCode == 13 && value.length == 3)
                              {
                                   if (confirm ('Are You Sure To Delete?')) 
                                  { document.frmtbledivi.submit(); } else { location.href = 'TBLEDIVI03.php'; }                           
                              } 
                ">
      ...
      <div class="pure-control-group">
        <label for="txtdiviname">Nama Divisi :</label>
         ...
         <span id="labelmessage2" 
            class="pure-form-message" 
            style="visibility: hidden;">Fill Code Jabatan.</span>
...
<script src="js/TBLEDIVI03.js"></script>
