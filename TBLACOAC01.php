...
<div id="layout">
    ...
    <!-- Form Input -->
    <form name="frmtblacoac" class="pure-form pure-form-aligned" method="post" action="TBLACOAC01E.php">
      <fieldset>
        ...
        <div class="pure-control-group">
          ...
          <label for="txtcoaccode">Account Code :</label>
            ...
            style="visibility: hidden;">Code Account is Exist!.</span>
        ...
        <label for="txtcoacname">Nama Akun :</label>
         ...
         <span id="labelmessage2" 
            class="pure-form-message" 
            style="visibility: hidden;">Fill Name Account!.</span>
...
<script src="js/TBLACOAC01.js"></script>
