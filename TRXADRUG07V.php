...
if ($panjangkata == 1 )
{ 
$xxxquery = "SELECT INVE_STOCK_CODE AS STOCK_CODE, INVE_PROC_CODE AS PROC_CODE,
                ...
                ORDER BY INVE_STOCK_NAME, INVE_ENTR_DATE DESC"; 
...
$q = $db->query($xquery) or die("Gagal Ambil Data Obat");
...
{ 
    ...
    echo '<td style="width: 150px">'.$row['INVE_ENTR_DATE'].'</td>';
