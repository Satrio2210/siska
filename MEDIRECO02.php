...
<title>Report Statistik ICD 10</title>
...
<div id="layout">
        ...
        <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'MEDIRECO01.php'">
    ...
    <!-- Tab Menu -->
      ...
      <form name="frmreport" class="pure-form" method="post" action="MEDIRECO02P.php">
...
<script src="js/MEDIRECO02.js"></script>
