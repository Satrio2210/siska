...
<body onload="periksaakses('PASS_MEDI_REPO'); //ambilviewid('x');">
<div id="layout">
	<!-- Menu toggle -->
	...
	<!-- Menu Kiri -->
    	<div id="menu">
            ...
            <a class="pure-menu-heading" href="#"><?php echo $_SESSION['username'];?></a>
              ...
              <li class="pure-menu-item menu-item-divided pure-menu-selected" onclick="javascript: location.href = 'REPOPATI01.php'">
 ...
 <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-disabled">
                Pasien Harian / Bulanan
              </li>
              
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'REPOPATI02.php'">
    ...
    <!-- Tab Menu -->
      ...
      <form name="frmreport" class="pure-form" method="post" action="REPOPATI01P.php">
      ...
      <fieldset>
          ...
          <a class="pure-button button-print" disabled="true">Print</a>
      </fieldset>
...
<script src="js/REPOPATI01.js"></script>
