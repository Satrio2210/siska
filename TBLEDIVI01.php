...
<div id="layout">
    ...
    <!-- Form Input -->
    <form name="frmtbledivi" class="pure-form pure-form-aligned" method="post" action="TBLEDIVI01E.php">
      <fieldset>
        ...
        <label for="txtdivicode">Kode Divisi :</label>
              ...
              <span id="labelmessage" 
                    ...
                    style="visibility: hidden;">Code Division is Exist!.</span>
      ...
      <div class="pure-control-group">
        <label for="txtdiviname">Nama Divisi :</label>
         ...
         <span id="labelmessage2" 
            class="pure-form-message" 
            style="visibility: hidden;">Fill Code Division!.</span>
...
<script src="js/TBLEDIVI01.js"></script>
