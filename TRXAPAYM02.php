...
<div id="layout">
        ...
        <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'TRXAPAYM01.php'">
    ...
    <!-- Tab Menu -->
      ...
      <form name="frmreport" class="pure-form" method="post" action="TRXAPAYM02P.php">
...
<script src="js/TRXAPAYM02.js"></script>
