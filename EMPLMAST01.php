...
<div id="layout">
    ...
    <!-- Tab Menu -->
    <!-- Form Input -->
    <form name="frmemplmast" class="pure-form pure-form-aligned" method="post" action="EMPLMAST01E.php">
   ...
   <fieldset><legend>Pendidikan</legend>
    ...
    <fieldset><legend>Payroll</legend>
        ...
        <fieldset>
              ...
              onclick="javascript: if (document.getElementById('txtfrstname').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Depan Kosong' ,
                                        text: 'Anda belum mengisi Nama Depan, silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }
                                    ...
                                    {
                                    swal({
                                        title: 'Nama Akhir Kosong' ,
                                        text: 'Anda belum mengisi Nama Akhir, silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    ...
                                    swal({
                                        title: 'Gender Kosong' ,
                                        text: 'Anda belum memilih Gender, silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    ...
                                    swal({
                                        ...
                                        text: 'Anda belum memilih Tipe Golongan Darah, silah periksa lagi',
                                        icon: 'warning',
                                        });

                                    }

                                    else if (document.getElementById('txtmaintidn1').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtmaintidn2').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                    ...
                                    else if (document.getElementById('txtmaintidn3').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                    ...
                                    else if (document.getElementById('txtmaintidn4').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                    ...
                                    else if (document.getElementById('txtmaintidn5').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                    ...
                                    else if (document.getElementById('txtmaintidn6').value.length == 0)
                                    {
                                    swal({
                                        title: 'Kode Pajak Kosong' ,
                                        text: 'Anda belum mengisi Kode Pajak , silah periksa lagi',
                                    ...
                                    else if (document.getElementById('txtmktpaddr').value.length == 0)
                                    {
                                    swal({
                                        title: 'Alamat Kosong' ,
                                        text: 'Anda belum mengisi Alamat , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtmktpcity').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Kota Kosong' ,
                                        text: 'Anda belum mengisi Nama Kota , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtmktpprov').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Provinsi Kosong' ,
                                        text: 'Anda belum mengisi Nama Provinsi , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtmainhp01').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nomor HP Kosong' ,
                                        text: 'Anda belum mengisi Nomor HP , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtmainmail').value.length == 0)
                                    {
                                    swal({
                                        title: 'Alamat email Kosong' ,
                                        text: 'Anda belum mengisi email , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtlastschl').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Lembaga Pendidikan terakhir kosong' ,
                                        text: 'Anda belum melengkapi pendidikan terakhir , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('hidmaindivi').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Divisi Kosong' ,
                                        text: 'Anda belum melengkapi Nama Divisi , silah periksa lagi',
                                        icon: 'warning',
                                        });

                                    }

                                    else if (document.getElementById('hidmainpstn').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Jabatan Kosong' ,
                                        text: 'Anda belum melengkapi Nama Posisi , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('hidbankcode').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Bank Kosong' ,
                                        text: 'Anda belum melengkapi Nama Bank , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtbankacct').value.length == 0)
                                    {
                                    swal({
                                        title: 'Akun Bank Kosong' ,
                                        text: 'Anda belum melengkapi Data Akun Bank , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }

                                    else if (document.getElementById('txtbankpers').value.length == 0)
                                    {
                                    swal({
                                        title: 'Nama Pemilik Rekening Kosong' ,
                                        text: 'Anda belum melengkapi Data Rekening Bank , silah periksa lagi',
                                        icon: 'warning',
                                        });
                                    }
...
<script src="js/EMPLMAST01.js"></script>
