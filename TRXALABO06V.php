...
$query1 = "SELECT DISTINCT(TRXA_STOCK_CODE) AS STOCK_CODE, 
          ...
          (SELECT SUM(TRXA_STOCK_QUTY) FROM trxacsbl 
                                       WHERE TRXA_STOCK_CODE = STOCK_CODE 
                                       AND TRXA_CSBL_STAT = 'P' 
                                       AND TRXA_VIEW_STAT = 'Y' 
                                       AND TRXA_ENTR_DATE = '$startdate') AS STOCK_QUTY,
          (SELECT SUM(TRXA_STOCK_QUTY * TRXA_STOCK_PRIC) FROM trxacsbl 
                                                         WHERE TRXA_STOCK_CODE = STOCK_CODE 
                                                         AND TRXA_CSBL_STAT = 'P' 
                                                         AND TRXA_VIEW_STAT = 'Y' 
                                                         AND TRXA_ENTR_DATE = '$startdate') AS TOTAL_SALE
          FROM trxacsbl WHERE TRXA_CSBL_STAT = 'P' AND TRXA_VIEW_STAT = 'Y' AND TRXA_MEDI_ROOM = '$code_lab_room'
