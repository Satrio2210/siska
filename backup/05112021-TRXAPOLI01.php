        ...
        <!-- Tab Menu -->
          <div class="pure-menu pure-menu-horizontal">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item pure-menu-selected" onclick="javascript: location.href = 'TRXAPOLI04.php'">
                <a class="pure-menu-link">
                Resep
                </a>
              </li>
    ...
    <form name="frmtrxapoli" class="pure-form pure-form-aligned" method="post" action="">
    	<fieldset>
          ...
          <div class="pure-control-group">
            ...
            <label for="txtpaticode">RM. :</label>
              	<input type="text" 
                  name="txtpaticode" 
                  id="txtpaticode" 
                  maxlength ="10"
          ...
          <div class="pure-control-group">
            ...
            <label for="txtexambody">Pemeriksaan Fisik :</label>
              <input type="text" 
                  ...
                  maxlength ="200"
                  style="width: 500px;"
                onkeydown="if (event.keyCode == 13 && value.length > 0) document.getElementById('txtexamdiag').focus()">
                ...
                onkeydown="if (event.keyCode == 13 && value.length > 0)
                  ...
                  else if (document.getElementById('txtexamdiag').value == '')
                  {
                   ...
                   else
                   {
                       ...
                       input(inexamcode,inexamdoct,inexamhght,inexamwght,inexamblod,inexamtemp,inexamanam,inexambody,inexamdiag);
