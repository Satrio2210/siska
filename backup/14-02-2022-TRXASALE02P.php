...
if (ISSET($_GET['regicode']))
{
	...
	$pdf->Cell(50,6,''.$drug_name.' '.$spec_name.'','L',0,'L'); 
	$pdf->Cell(30,6,'  ','R',0,'L'); 
...
// Periksa apakah ada obat racikan
	...
	$pdf->Cell(20,6,'Account No.','LTBR',0,'L'); 
	$pdf->Cell(20,6,'Account Name','LTBR',0,'L'); 
	$pdf->Cell(25,6,'Description','LTBR',0,'L');
	$pdf->Cell(40,6,'Cashier','LTBR',0,'R'); 
	$pdf->Cell(25,6,'Patient','LTBR',1,'R');
	...
	$pdf->Cell(20,8,' ','LTBR',0,'R'); 
	$pdf->Cell(20,8,' ','LTBR',0,'L'); 
	$pdf->Cell(25,8,' ','LTBR',0,'R');
	$pdf->Cell(40,8,''.$cashier.'','LTBR',0,'R'); 
