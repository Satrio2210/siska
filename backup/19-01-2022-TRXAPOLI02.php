    ...
    <form name="frmtrxapoli" class="pure-form pure-form-aligned" method="post" action="">
          ...
          <div class="pure-control-group">
            ...
            <label for="txtmedicode">Layanan/Tindakan :</label>
              <input type="text" 
                  ...
                  ambiltindakan(this.value,regipoli);
                  } 
                else 
                  { 
      ...
      <fieldset>
        ...
        ">Input</a>
          ...
          <a class="button-update pure-button" onclick="javascript: location.href = 'TRXAPOLI02.php'">Close</a>
...
<script src="js/TRXAPOLI02.js"></script>
