    	...
    	<fieldset>
          ...
          <div class="pure-control-group">
            ...
            <label for="hidpaticare">Rawat Inap :</label>
              ...
              <label for="optpaticare-no">Tidak Ada</label>
                <input type="checkbox"
                      name="optpaticare-no" 
                      id="optpaticare-no"
                      value="true"
                      onclick="if (checked == true) 
                        ...
                        ">
              <label for="optpaticare-yes">Ada</label>
                <input type="checkbox"
          ...
          <div class="pure-control-group">
            ...
            <label for="hidpatisurge">Operasi :</label>
              ...
              <label for="optpatisurge-no">Tidak Ada</label>
                <input type="checkbox"
                      ...
                      onclick="if (checked == true) 
                        ...
                        ">
              <label for="optpatisurge-yes">Ada</label>
                <input type="checkbox"
