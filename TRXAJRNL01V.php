...
"SELECT  TRXA_JRNL_DATE,
  ...
  FROM trxajrnl
  WHERE TRXA_JRNL_CODE = '$kodetransaksi' AND TRXA_JRNL_STAT='I'
...
echo '<td style="width: 100px;" onClick="hapuscode(\''.$kodetransaksi.'\',\''.$coaccode.'\',\''.$entrtime.'\');" 
      style="cursor:pointer"><b>Cancel</b></td>';

echo '<td style="width: 100px">'.$k['TRXA_JRNL_DATE'].'</td>';
