...
list($examcode,$examdoct,$examhght,$examwght,$examblod,$examtemp,$medialle,$foodalle,$chrodsse,$othrdsse,$paticare,$patisurge,$patismoke,$examanam,$exambody,$examdiag,$examprsc) = explode("|", $rawdata);
...
$input = "INSERT INTO trxaexam (
         TRXA_EXAM_CODE, TRXA_EXAM_DOCT, TRXA_EXAM_HGHT,
         TRXA_EXAM_WGHT, TRXA_EXAM_BLOD, TRXA_EXAM_TEMP,
         TRXA_EXAM_ANAM, TRXA_EXAM_BODY, TRXA_EXAM_DIAG, 
        ...
        ':TRXA_EXAM_CODE' =>$examcode,':TRXA_EXAM_DOCT' =>$examdoct,':TRXA_EXAM_HGHT' =>$examhght,                
        ':TRXA_EXAM_WGHT' =>$examwght,':TRXA_EXAM_BLOD' =>$examblod,':TRXA_EXAM_TEMP' =>$examtemp,
        ':TRXA_EXAM_ANAM' =>$examanam,':TRXA_EXAM_BODY' =>$exambody,':TRXA_EXAM_DIAG' =>$examdiag,
        ':TRXA_EXAM_PRSC' =>$examprsc,':TRXA_VIEW_STAT' =>$viewstat,
...
$input = "INSERT INTO trxaassm (
        ...
        $db->beginTransaction();
        $query_input->execute(array(
        ':TRXA_ASSM_CODE' =>$examcode,':TRXA_MEDI_ALLE' =>$medialle,':TRXA_FOOD_ALLE' =>$foodalle,                
        ':TRXA_CHRO_DSSE' =>$chrodsse,':TRXA_OTHR_DSSE' =>$othrdsse,':TRXA_PATI_CARE' =>$paticare,
        ':TRXA_PATI_SURGE' =>$patisurge,':TRXA_PATI_SMOKE' =>$patismoke,':TRXA_VIEW_STAT' =>$viewstat,
        ':TRXA_ENTR_DATE' =>$dateinput, ':TRXA_ENTR_TIME' =>$timeinput, ':TRXA_ENTR_USER' =>$userid,
        ':TRXA_UPDT_DATE' =>$dateinput, ':TRXA_UPDT_TIME' =>$timeinput, ':TRXA_UPDT_USER' =>$userid));  
        ///print_r($db->error_Info());
        ///var_dump($query_input);
