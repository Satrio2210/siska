...
<body onLoad="periksaakses('PASS_STOCK_ADJU');  
">
<div id="layout">
	<!-- Menu toggle -->
	...
	<!-- Menu Kiri -->
    	<div id="menu">
            ...
            <a class="pure-menu-heading" href="#"><?php echo $_SESSION['username'];?></a>
              ...
              <li class="pure-menu-item" onclick="javascript: location.href = 'PERSEDIAAN.php'">
    ...
    <!-- Form Input -->
    <form name="frminvestock" class="pure-form pure-form-aligned" method="post" action="">
    	<fieldset>
        <div id="tblviewopna">
      </fieldset>
...
<script src="js/INVESTOCK02.js"></script>
