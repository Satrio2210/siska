...
<body onLoad="periksaakses('PASS_IDEN_VIEW');
">
<div id="layout">
	<!-- Menu toggle -->
    ...
    <!-- Form Input -->
    <form name="frmpassiden" class="pure-form" method="post" action="PASSIDEN03D.php">
        <fieldset>
            <legend>User ID / User Name</legend>
            <input type="text" 
                name="txtuseriden" 
                id="txtuseriden" 
                maxlength ="5" 
...
<script src="js/PASSIDEN04.js"></script>
