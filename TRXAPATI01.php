    ...
    <form name="frmtrxapati" class="pure-form pure-form-aligned" method="post" action="TRXAPATI01E.php">
    	...
    	<div class="pure-control-group">
      	...
      	<label for="optmainstat">Status :</label>
							<select name="optmainstat" id="optmainstat" onchange="document.getElementById('txtmainprof').focus();">
    	...
    	<div class="pure-control-group">
      	...
      	<label for="optmaineduc">Pendidikan :</label>
							<select name="optmaineduc" id="optmaineduc" onchange="document.getElementById('txtmainphne').focus();">
        ...
        <fieldset>
        	    ...
        	    <a class="pure-button pure-button-primary" 
             	onclick="javascript: if (document.getElementById('txtmainpidn').value.length == 0 )
                                    {
                    				swal({
                        				title: 'NIK Kosong' ,
                        				text: 'Anda belum mengisi NIK, silah periksa lagi',
...
<script src="js/TRXAPATI01.js"></script>
