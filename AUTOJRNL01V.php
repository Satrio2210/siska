...
<?php
  ...
  echo '<tr>';
  echo '<td style="width: 50px">'.$no.'</td>';
  echo '<td style="width: 200px">'.$action_name.'</td>';
...
<?php
  ...
  echo '<tr>';
  echo '<td style="width: 50px">'.$no.'</td>';
  echo '<td style="width: 200px">'.$tret_name.'</td>';
...
?>
  ...
  <tr>
  <td style="width: 50px"></td>
  <td style="width: 200px">CONSUMABLE</td>
  <td style="width: 100px"> </td>
  <td style="width: 100px"> </td>
  <td style="width: 100px"> </td>
  <td style="width: 100px"> </td>
...
<?php
  ...
  echo '<tr>';
  echo '<td style="width: 50px">'.$no.'</td>';
  echo '<td style="width: 200px">'.$csbl_name.'</td>';
...
?>
    ...
    echo '<td style="width: 125px; text-align: right;"><b>ADMIN</b></td>';
    ...
    // discont
    echo '<td style="width: 125px; text-align: right;">0</td>';
    // admin charge
    ...
    echo '<td style="width: 125px; text-align: right;">'.$view_fee_admin.'</td>';
    // total
