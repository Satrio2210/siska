          ...
          <form name="frmtrxaregi" class="pure-form pure-form-aligned" method="post" action="">
            <fieldset>
              ...
              <div class="pure-control-group">
                ...
                <input type="text" name="txtmainname" id="txtmainname" maxlength="50" style="width: 300px;"
                  readonly="true">
              ...
              <div class="pure-control-group">
                ...
                <input type="text" name="txtmainbirt" id="txtmainbirt" maxlength="50" style="width: 200px;"
                  readonly="true">


                <label for="txtmaingend">L/P :</label>
                <input type="text" name="txtmaingend" id="txtmaingend" maxlength="50" style="width: 100px;"
                  readonly="true">
              ...
              <div class="pure-control-group">
                ...
                <input type="text" name="txtexamhght" id="txtexamhght" maxlength="10" style="width: 60px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
                ...
                <input type="text" name="txtexamwght" id="txtexamwght" maxlength="10" style="width: 60px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
                                  document.getElementById('txtexamwaist').focus();
                            }"> Kg
              ...
              <div class="pure-control-group">
                ...
                <label for="txtexamwaist">Lingkar Perut :</label>
                <input type="text" name="txtexamwaist" id="txtexamwaist" maxlength="10" style="width: 60px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {

                                  document.getElementById('txtexamblod').focus();
                                }"> cm

                <label for="txtexambmi">IMT :</label>
                <input type="text" name="txtexambmi" id="txtexambmi" maxlength="10" style="width: 60px;" readonly="true">Kg/m2
              ...
              <div class="pure-control-group">
                ...
                <input type="text" name="txtexamtemp" id="txtexamtemp" maxlength="10" style="width: 50px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
                                  document.getElementById('txtexamrr').focus();
                            "> Celcius
              ...
              <div class="pure-control-group">
                ...
                <label for="txtexamrr">Respiratory Rate :</label>
                <input type="text" name="txtexamrr" id="txtexamrr" maxlength="10" style="width: 100px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
                                  document.getElementById('txtexamhr').focus();
                            }"> / minute

                <label for="txtexamhr">Heart Rate :</label>
                <input type="text" name="txtexamhr" id="txtexamhr" maxlength="10" style="width: 50px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
                                  document.getElementById('txtexamhr').focus();
                            "> bpm
              ...
              <div class="pure-control-group">
                ...
                <label for="txtexamcomp">Keluhan :</label>
                <input type="text" name="txtexamcomp" id="txtexamcomp" maxlength="50" style="width: 400px;" onkeydown="if (event.keyCode == 13 && value.length > 0) 
                            {
